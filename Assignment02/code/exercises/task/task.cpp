...
bool initDice()
{
    ...
    gDice[0]->modelMatrix().rotate(-90.f,ogl::Vec3f(0,1,0)).scale(2,2,2).translate(4,3,1);
    
    //gDice[1] should be the cube with number 2 facing the camera
    gDice[1]->modelMatrix().rotate(90.f,ogl::Vec3f(0,0,1)).translate(2.5,2.5,2);
    
    //gDice[2] should be the cube with number 3 facing the camera
    gDice[2]->modelMatrix().rotate(180.f,ogl::Vec3f(0,1,0)).translate(2.5,3.5,3);
    
    //gDice[3] should be the cube with number 4 facing the camera
    gDice[3]->modelMatrix().rotate(-90.f,ogl::Vec3f(0,0,1)).translate(2.5,3.5,3);
